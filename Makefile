...
release-check: test test-asan test-ubsan doc-strict
...
.PHONY: all tests test test-asan test-ubsan install uninstall doc-check doc doc-examples doc-strict release-check doc-clean doc-clean-all clean
