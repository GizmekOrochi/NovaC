#include "novac/assets/language/features/IdentifierExpressionFeature.hpp"
...
LanguageFeatureInfo IdentifierExpressionFeature::info() const {
    return {"language.identifier-expression", "0.1.0", "Identifier expression parsing and runtime lookup", {"expression.identifier", "expression.atom"}, {}, {}, {}, {}};
}
