...
class LogicalOperatorSyntaxFeature final : public LanguageFeature {
public:
    explicit LogicalOperatorSyntaxFeature(std::string expressionDomain = "expr", std::string binaryNodeKind = "BinaryExpr");
